        ...
        <div className="space-y-6">
            <header className="bg-slate-950 text-white rounded-3xl p-7 shadow-xl shadow-slate-900/10 relative overflow-hidden">
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between gap-5">
                    <div><p className="text-emerald-300 text-xs font-black uppercase tracking-[0.2em]">Performance center</p><h2 className="text-3xl font-black tracking-tight mt-2">Laporan Penjualan</h2><p className="text-slate-200 text-sm mt-2">Baca ritme bisnis, temukan kategori kuat, dan pantau risiko stok.</p></div>
